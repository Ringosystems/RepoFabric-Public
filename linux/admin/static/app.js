...
const CFG_SECTIONS = [
  { key: 'target', title: 'Target stack (Gitea + nginx installer host)', tier: 'advanced', fields: [
    ...
    { k: 'installer_base_url', label: 'Installer base URL',       type: 'text',   placeholder: 'https://installers.winget.example.com',
      help: 'Public https origin where installer binaries are served from. Manifests rewrite their InstallerUrl to <installer_base_url>/<package>/<version>/<filename>. No trailing slash. The repofabric-linux container serves the files directly on host port 8091. Convention is an installers. subdomain of your source host; it needs its own DNS record, a reverse-proxy route to 8091, and a TLS cert that covers it (a base-domain wildcard will not).' },
